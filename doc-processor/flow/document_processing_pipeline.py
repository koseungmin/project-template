                            ...
                            "content": [
                                {
                                    ...
                                    "text": '''
                                            ...
                                            <차트> … </차트>
                                            이미지 대신 Description(종류, 제목/축, 주요 수치·비율, 색상·범례·강조, 핵심 메시지 1문장).
                                            <그래프> … </그래프>
                                            이미지 대신 Description(유형·축, 주요 변화 패턴, 시각적 특징, 핵심 의미 1문장).
                                            <사진> … </사진>
                                            이미지 대신 Description(제품 종류·구도·부품·재질·배경·조명·상태 등) + 요약 1문장.
                                            <그림> … </그림>
                                            도면/일러스트 설명(종류·구성·선/색상·기호 등) + 핵심 전달 내용 1문장.
                                            ...
                                            (태그는 원본 이미지에서 해당 요소가 있던 위치 순서대로 나열하고 중복으로 표현하지 않습니다.)
